...
class MLearningController:
    ...
    def algoritmos(self, entrenamiento: InfoEntrenamiento, nombre_dataset):
        ...
        entrenamiento.nombre_algoritmo = self.utils.arreglar_nombre(
            entrenamiento.nombre_algoritmo)
        if entrenamiento.nombre_algoritmo == "KNN":
            respuesta = self.mlearning_service.knn(
            ...
            respuesta = self.mlearning_service.naive_bayes(
                entrenamiento, nombre_dataset)
            if isinstance(respuesta, str):
                return self.utils.prueba(msg=respuesta)
            ...
            respuesta = self.mlearning_service.regresion_logistica(
                entrenamiento, nombre_dataset)
            if isinstance(respuesta, str):
                return self.utils.prueba(msg=respuesta)
            ...
            respuesta = self.mlearning_service.svm(
                entrenamiento, nombre_dataset)
            if isinstance(respuesta, str):
                return self.utils.prueba(msg=respuesta)
            ...
            respuesta = self.mlearning_service.arbol_decision(
                entrenamiento, nombre_dataset)
            if isinstance(respuesta, str):
                return self.utils.prueba(msg=respuesta)
            ...
            respuesta = self.mlearning_service.regresion_lineal(
                entrenamiento, nombre_dataset)
            if isinstance(respuesta, str):
                return self.utils.prueba(msg=respuesta)
